...
struct PerroNivel1: View {
    
    let synthesizer = AVSpeechSynthesizer()
    @State var textToSpeech = true
    
    @Environment(\.dismiss) private var dismiss
    @State var imagen = "Nivel1/dogversion1"
                    ...
                    ZStack {
                        ...
                        Image(imagen)
                            ...
                            .onTapGesture {
                                ...
                                imagen = "Nivel1/dogversion2"
                                Task {
                                    try? await Task.sleep(nanoseconds: UInt64(1 * 1E9))
                                    imagen = "Nivel1/dogversion1"
                                }
                            }
                        Button(action: {
                            dismiss()
...
struct PerroNivel1_Previews: PreviewProvider {
