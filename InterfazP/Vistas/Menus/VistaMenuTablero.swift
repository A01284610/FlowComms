...
struct VistaMenuTablero: View {
    
    @Environment(\.dismiss) private var dismiss
    
    @State private var mostrarEditorPictogramas = false
                    ...
                    VStack(spacing: 0) {
                        HStack(spacing: 0) {
                            ...
                            VStack {
                                ...
                                .fullScreenCover(isPresented: $mostrarEditorPictogramas){
                                    ...
                                    TableEditor(board: Tablero(nombre: "plchldr", numCol: 1, numRow: 1, descripcion: "plchldr", imagenes: tempImages))
                                }
                            }
                            
                            Spacer()
                            VStack {
                                Text("Acceder tablero")
                                    .font(.custom("HelveticaNeue", size: 60))
                                    .bold()
                                    .foregroundColor(.white)
...
struct VistaMenuTablero_Previews: PreviewProvider {
